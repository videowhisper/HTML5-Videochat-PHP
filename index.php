...
<body>
<?php echo $bodyCode ?>
<div class="ui segment"><h4 class="ui header">HTML5 Videochat - Plain PHP</h4>This is a simple embedding preview edition, with simple scripts to embed app and showcase few features. Live demo for this edition is available at <a href="https://videowhisper.com/demos/html5-videochat/">HTML5 Videochat - Plain PHP - Live Demo</a>. For implementation of advanced capabilities, see <a href="https://paidvideochat.com/html5-videochat/">Turnkey HTML5 Videochat Site</a> edition, available as WordPress plugin with full php source.
</div>
</body>